    ...
    <div class="right-menu">
      <template v-if="device!=='mobile'">
        ...
        <el-tooltip content="源码地址" effect="dark" placement="bottom">
          <ruo-yi-git id="rail-git" class="right-menu-item hover-effect" />
        </el-tooltip>

        <el-tooltip content="文档地址" effect="dark" placement="bottom">
          <ruo-yi-doc id="rail-doc" class="right-menu-item hover-effect" />
        </el-tooltip>
...
import RailGit from '@/components/Rail/Git'
import RailDoc from '@/components/Rail/Doc'
