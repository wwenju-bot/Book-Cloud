      ...
      <div class="content-inner">
        <el-form :model="querailParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
          <el-form-item label="用户名称" prop="userName">
            <el-input v-model="querailParams.userName" placeholder="请输入用户名称" clearable style="width: 240px" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="手机号码" prop="phonenumber">
            <el-input v-model="querailParams.phonenumber" placeholder="请输入手机号码" clearable style="width: 240px" @keyup.enter.native="handleQuery" />
          </el-form-item>
          <el-form-item label="状态" prop="status">
            <el-select v-model="querailParams.status" placeholder="用户状态" clearable style="width: 240px">
        ...
        <pagination v-show="total > 0" :total="total" :page.sync="querailParams.pageNum" :limit.sync="querailParams.pageSize" @pagination="getList" />
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listUser(this.addDateRange(this.querailParams, this.dateRange)).then(response => {
    ...
    handleNodeClick(data) {
      this.querailParams.deptId = data.id
      this.handleQuery()
    },
    // 用户状态修改
    ...
    resetQuery() {
      ...
      this.querailParams.deptId = undefined
