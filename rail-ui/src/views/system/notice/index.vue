  ...
  <div class="app-container">
    <el-form :model="querailParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="公告标题" prop="noticeTitle">
        <el-input
          v-model="querailParams.noticeTitle"
          placeholder="请输入公告标题"
          clearable
      ...
      <el-form-item label="操作人员" prop="createBy">
        <el-input
          v-model="querailParams.createBy"
          placeholder="请输入操作人员"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="类型" prop="noticeType">
        <el-select v-model="querailParams.noticeType" placeholder="公告类型" clearable>
          <el-option
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listNotice(this.querailParams).then(response => {
