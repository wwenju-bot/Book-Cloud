    ...
    <div class="right-menu">
      <template v-if="device!=='mobile'">
        ...
        <el-tooltip content="源码地址" effect="dark" placement="bottom">
          <ruo-yi-git id="book-git" class="right-menu-item hover-effect" />
        </el-tooltip>

        <el-tooltip content="文档地址" effect="dark" placement="bottom">
          <ruo-yi-doc id="book-doc" class="right-menu-item hover-effect" />
        </el-tooltip>
...
import BookGit from '@/components/Book/Git'
import BookDoc from '@/components/Book/Doc'
